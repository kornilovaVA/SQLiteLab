...
class MainApp(QMainWindow):
    ...
    def initialize_db(self):
        ...
        (3, 'Отцы и дети', 'И. С. Тургенев', 'Издательство В', 1962),
        (4, 'Анна Каренина', 'Л. Н. Толстой', 'Издательство Г', 1977),
        (5, 'Собачье сердце', 'М. А. Булгаков', 'Издательство Д', 2023);
        """)
        ...
        (3, 'Сидоров', 'ул. Гоголя, 3', 1978, 'Неоконченное высшее'),
        (4, 'Кузнецов', 'ул. Чехова, 4', 2000, 'Среднее'),
        (5, 'Смирнов', 'ул. Толстого, 5', 1995, 'Высшее');
        """)

        query.exec_("""
        (1, 1, '2024-01-01', '2024-01-15', '2024-01-20'),
        (2, 2, '2024-02-01', '2024-02-15', 'NULL'),
        (3, 3, '2024-03-01', '2024-03-15', '2024-03-17'),
        (4, 4, '2024-04-01', '2024-04-15', '2024-04-16'),
        (5, 5, '2024-05-01', '2024-05-15', '2024-05-18');
        """)
